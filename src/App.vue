<template>
    ...
    <el-container id="app">
        ...
        <el-footer id="app-footer">
            ...
            <el-row>
                <a href="https://github.com/ix64/unlock-music/issues/new/choose" target="_blank"><el-button icon="el-icon-chat-line-square" size="mini" round type="primary">意见反馈</el-button></a> <a href="https://github.com/ix64/unlock-music" target="_blank"><el-button icon="el-icon-receiving" size="mini" round type="warning">开放源代码</el-button></a>
            </el-row>
        </el-footer>
    </el-container>
